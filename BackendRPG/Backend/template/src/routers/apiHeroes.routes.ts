...
apiHeroesRouter.put('/api/v1/updateHeroes/:id', catchErrors(HeroesController.update));
apiHeroesRouter.get('/api/v1/deleteHeroes/:id', catchErrors(HeroesController.delete));
