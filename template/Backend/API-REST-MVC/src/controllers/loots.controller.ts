...
class LootController {
    ...
    static findById = async (req: Request, res: Response) => {
        const { id } = req.params;
        const loot = await LootController.lootRepository?.findOne(id, {relations :['monsters']});
        if (loot === undefined) {
    ...
    static update = async (req: Request, res: Response) => {
        ...
        const mergeLoot = LootController.lootRepository?.merge(loot, req.body);
    ...
    //test
    // static findLootByMonsterId = async (req : Request, res : Response) =>{
    //     const loots = await LootController.lootRepository?.findOne(req.params.id);
    //     return res.json(loots);        
    // }
